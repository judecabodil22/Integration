    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
			...
			<div class="col-md-12">                      
                                                  ...
                                                  <label class="col-md-2 control-label" for="deptname">Requested By</label>  
                                                  <div class="col-md-3">
                                                  ...
                                                  <label class="col-md-2 control-label" for="deptdesc">Purpose</label>
                                                  <div class="col-md-5">                     
                                                    <form:textarea  rows="3" cols="200" class="form-control" id="purpose" name="purpose" path="purpose"/>
...
<!-- ========================================================================================================================================== -->												                                                 
  ...
  <label>Item</label>
    <div class="multi-field-wrapper">
      ...
      <div class="col-md-2"> <form:input type="text" name="itemqty" placeholder="Item" class="form-control col-md-3" path="itemName"/></div>
          <div class="col-md-2"> <form:input type="number" name="itemqty" placeholder="Qty" class="form-control col-md-3" path="itemQty"/></div>
           <div class="col-md-2">   <form:textarea  rows="5" cols="200" class="form-control" id="itemdesc" name="itemdesc" path="itemDesc"/></div>
