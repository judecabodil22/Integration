                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" style="width: 50px;" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1">Received No.</th>
                                            ...
                                            : activate to sort column ascending" style="width: 200px;">Item Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Points
                                            : activate to sort column ascending" style="width: 150px;">Received By</th>
                                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Points
                                            : activate to sort column ascending" style="width: 100px;">Received Quantity</th>
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Notes
                                            : activate to sort column ascending" style="width: 50px;">Received Date </th>
                                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Notes
                                            : activate to sort column ascending" style="width: 80px;">Location </th>
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Edit
                                            : activate to sort column ascending" style="width: 88px;">Inspect</th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                            <div align="center">
                                     		        <button type="button" class="btn btn-xs btn-success" date-delivery="" item-qty="" vendor-name="Geo" po-no="01" item-id="" item-name=""  data-toggle="modal" href="#edit_modal" title="Edit Warehouse">
                   ...
                   <div class="modal-dialog">  													
                       <div class="modal-content">
                           <div class="modal-header">
                               ...
                               <h3 class="modal-title">Inspect Item</h3>
                               <p>Input the number of items inspected in the delivery.</p>
                           </div>
                           <div class="modal-body">
							<form:form class="form-horizontal" method="post" action="warehouse-list" modelAttribute="" id="updateForm">
							<fieldset>							
							<input name="warehouseId" id="warehouseid" style="display: none"></input>				 
                            
                            <p align="left">
                              Quantity Passed :
                            <input id="" name="itr_quantity" type="text" class="form-control">
                            </p>
                            <p align="left">
                              Remarks :
                            <input id="" name="itr_remarks" type="text" class="form-control">
                            </p>
                            <p align="left">
                              Inspected By :
                            <input id="" name="" type="text" placeholder="Admin" class="form-control" disabled>
                            </p>
							<br>
